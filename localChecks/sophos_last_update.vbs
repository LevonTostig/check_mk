' -----------------------------------------------------------------------------------------
' sophos_last_update.vbs - local check to monitor how many days passed since
' last update of Sophos Endpoint Security
'
' To use this just place it in the local/ directory below the path of the
...
' Editor: kener
'
' Based on code from makanakoeln and here:
'
' -----------------------------------------------------------------------------------------
...
WScript.echo status & " " & checkName & " - " & output & intDateDifference
WScript.Quit(status)
